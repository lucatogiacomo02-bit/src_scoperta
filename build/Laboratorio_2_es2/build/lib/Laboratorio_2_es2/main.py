...
class LimoYoloNode(Node):
    ...
    def __init__(self):
        ...
        self.declare_parameter("filter_class", "elephant")        # Classe target da individuare: può essere cambiata a "sports ball" (# TODO)
    ...
    def detect_target(self, xyxy: np.ndarray, conf: np.ndarray, cls_ids: np.ndarray, image_h: int, image_w: int,
        ...
        for i in range(len(xyxy)):
            ...
            # Controllare la soglia di confidenza: se non è abbastanza elevata, l'elemento corrente non va considerato
            # Fare inoltre in modo da escludere eventuali oggetti distrattori
            # TODO
